...
namespace TwentyOne// namespace must be the same between class and this.
{
    class Program
    {
        static void Main(string[] args)
        {
            Deck deck = new Deck();
            int timesShuffled = 0;
             deck = Shuffle(deck, out timesShuffled, 3); // this will shuffle the deck 3 times
        ...
        public static Deck Shuffle(Deck deck, out int timesShuffled , int times = 1)// method to shuffle deck
        {
            timesShuffled = 0;
