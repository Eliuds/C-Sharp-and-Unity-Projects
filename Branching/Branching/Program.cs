...
namespace Branching
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string result = favnum == 55 ? "You have an awesome favorite number." : "You do not have an awesome favorite number.";
            ...
            //else
            //{
            //    Console.WriteLine(" uo-oh.... something went wrong.");
            //}
            //int currentTemp = 70;
            //int roomTemp = 70;
            ...
            //else if (roomTemp > currentTemp)
            //{
            //    Console.WriteLine("Room temp is warmer then the current temperature.");
            //}
            //else
            //{
